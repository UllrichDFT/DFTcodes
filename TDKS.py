...
#
#--------------------------------------------------------------------------
NGRID = 121    # number of grid points (always an odd number)
...
DT = 0.1       # time step
EFIELD = 0.5   # strength of the electric field kick
TKICK = 0.3    # duration of the kick
DYN = 2        # If DYN=2, use both time-dependent Hartree and exchange
               # IF DYN=1 use time-dependent Hartree and ground-state exchange
               # If DYN=0, use both ground-state Hartree and exchange               
PC = 1         # number of predictor-corrector steps; usually no more than 1
#--------------------------------------------------------------------------
#
